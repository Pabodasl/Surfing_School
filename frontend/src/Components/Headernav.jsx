    ...
    <header className="bg-gradient-to-r from-blue-300 to-slate-200 shadow-lg">
      <div className="flex justify-between items-center max-w-6xl mx-auto p-4">
        ...
        <nav className={`${menuOpen ? 'block' : 'hidden'} sm:flex space-x-6`}>
          ...
          <Link to="/equipment" className="text-slate-700 hover:text-blue-600 transition duration-300">
            Equipment
          </Link>
      ...
      {menuOpen && (
        <div className="sm:hidden bg-slate-100 shadow-md mt-2">
          <nav className="flex flex-col">
            ...
            <Link to="/equipment" className="px-4 py-2 text-slate-700 hover:bg-blue-100">
              Equipments
            </Link>
